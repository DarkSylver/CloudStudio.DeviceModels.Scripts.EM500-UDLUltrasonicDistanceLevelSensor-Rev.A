...
# Configuration Script – EM500-UDL Ultrasonic Distance/Level Sensor - Rev. A

This **Configuration** script is designed for the **EM500-UDL Ultrasonic Distance/Level Sensor** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – EM500-UDL Ultrasonic Distance/Level Sensor Rev. A

Este script de **Configuration** está diseñado para el modelo **EM500-UDL Ultrasonic Distance/Level Sensor** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
